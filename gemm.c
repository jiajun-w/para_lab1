                ...
                for(int pc=0; pc < mc; pc += MR){   //2-nd loop
                    ...
                    for(int qc=0; qc < nc; qc +=NR){ //1-st loop
                        ...
                        for(int i=0; i<mr; i++)
                            for(int j=0; j<nr; j++)
                                for(int k=0; k<kc; k++)
                                *(C_ptr+i*N+j) = (*(A_ptr + i*K + k)) * (*(B_ptr + j*K + k));
                        /*
                        if(mr == 1 && nr == 1)
                            rank_1x1(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 1 && nr == 2)
                            rank_1x2(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 1 && nr == 3)
                            rank_1x3(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 1 && nr == 4)
                            rank_1x4(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 2 && nr == 1)
                            rank_2x1(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 2 && nr == 2)
                            rank_2x2(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 2 && nr == 3)
                            rank_2x3(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 2 && nr == 4)
                            rank_2x4(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 3 && nr == 1)
                            rank_3x1(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 3 && nr == 2)
                            rank_3x2(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 3 && nr == 3)
                            rank_3x3(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 3 && nr == 4)
                            rank_3x4(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 4 && nr == 1)
                            rank_4x1(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 4 && nr == 2)
                            rank_4x2(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 4 && nr == 3)
                            rank_4x3(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        else if(mr == 4 && nr == 4)
                            rank_4x4(A_ptr,B_ptr,C_ptr,kc,M,N,K);
                        */
